...
CLIENT_ID = json.loads(open('/var/www/FLASKAPPS/FullStackNano/Project-LinuxServer/catalogapp/client_secrets.json', 'r').read())[
    'web']['client_id']
recentItems = deque('')
...
def gconnect():
    ...
    code = request.data
    try:
        oauthflow = flow_from_clientsecrets('/var/www/FLASKAPPS/FullStackNano/Project-LinuxServer/catalogapp/client_secrets.json', scope='')
